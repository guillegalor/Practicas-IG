...
void CamaraInteractiva::moverHV( float nh, float nv )
{
    ...
    {
        // DONE: práctica 5: actualizar 'longi' y 'lati' y recalcular marco de cámara
        // .....
        longi += nh*urot;
        lati += nv*urot;
...
void CamaraInteractiva::desplaZ( float nz )
{
    ...
    if ( examinar ) // examinar
    {
        // DONE: práctica 5: actualizar 'dist' usando 'nz', 'dmin' y 'porc' y recalcular marco de cámara
        // .....
    ...
    {
        // DONE: práctica 5: desplazar 'mcv.org' en Z, y recalcular la matriz de vista
        // (y movimiento solidario del punto de atención)
        // .....
        mcv.org[2] += nz*udesp;
        recalcularMatrMCV();
...
{
    // DONE: práctica 5: fija punt. aten. y activa modo examinar, recalcula marco de camara
    // .....
...
{
    // DONE: práctica 5: activa modo examinar (no es necesario recalcular el marco de cámara)
    // .....
...
{
    // DONE: práctica 5: activa modo primera persona (no es necesario recalcular el marco de cámara)
    // .....
